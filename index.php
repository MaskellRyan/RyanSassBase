...
<body>
	...
	<div class="row">
		<div class="logomark"><a data-scroll href="#top"><img src="http://www.placehold.it/100x55" alt=""></a></div>
		<ul>
...
<div class="row">
	...
	<div class="clearfix" id="gallery">
		...
		<div class="ftg-filters">
			...
			<a href="#tag2">Tag Name</a>
		</div>

		<div class="ftg-items">
			<ul id="gallery-items" class="editable-gallery ftg-items">
				<li>
					<a class="tile-inner" href="_/img/200x100.gif">
						<img class="item" src="_/img/200x100.gif" alt="tag"/>
					</a>
				</li>
				<li>
					<a class="tile-inner" href="_/img/200x200.gif">
						<img class="item" src="_/img/200x200.gif" alt="tag2"/>
					</a>
				</li>
				<li>
					<a class="tile-inner" href="_/img/200x250.gif">
						<img class="item" src="_/img/200x250.gif" alt="tag2"/>
					</a>
				</li>
				<li>
					<a class="tile-inner" href="_/img/200x300.gif">
						<img class="item" src="_/img/200x300.gif" alt="tag"/>
					</a>
				</li>
				<li>
					<a class="tile-inner" href="_/img/200x200.gif">
